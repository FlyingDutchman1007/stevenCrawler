...
/**
 * @ClassName BasicCrawlerController
 * @Description TODO
 * @Author Steven
 * @Date 2022/9/20
 * @Version 1.0
...
public class BasicCrawlerController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        config.setMaxPagesToFetch(20010);
...
//        CrawlController.WebCrawlerFactory<BasicCrawler> factory = () -> new BasicCrawler(crawler1Domains);
        CrawlController.WebCrawlerFactory<MyCrawler> factory = () -> new MyCrawler(crawler1Domains);
//        MyCrawler myCrawler = new MyCrawler(crawler1Domains);
